 ...
 */
function render_embed_youtube( $attributes, $content, $block ) {
	// echo('php running');
    ...
    return '      <div react-component="ReactPlayer" url={url}>
    Ayoo
      </div>';
 ...
 */
function register_embed_youtube() {
    // echo('registering..');
    ...
    register_block_type( plugin_dir_path( __FILE__ ) .'../build', array(
        ...
        'render_callback' => 'render_embed_youtube'
    ) );

}
add_action( 'init', 'register_embed_youtube' );
