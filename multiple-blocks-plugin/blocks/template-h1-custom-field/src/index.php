...
function register_block_template_h1_custom_field() {
    ...
    register_block_type( plugin_dir_path( __FILE__ ) .'../build', array(
        'api_version' => 2,
        'render_callback' => 'render_block_template_h1_custom_field'
    ) );

}
add_action( 'init', 'register_block_template_h1_custom_field' );